<%@ Page Title="All Ads" Language="C#" MasterPageFile="~/SiteHeader.Master" AutoEventWireup="true" CodeBehind="AllAds.aspx.cs" Inherits="AddPostWebForm.AllAds" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <div class="row">
            <div class="logincolumn vr" style="background-color: white; padding-left: 50px;align-content:center">
                <br />
                ...
                <asp:Repeater ID="CategoryRepeat" runat="server">
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="Category" runat="server" OnClick="Category_click" CommandArgument='<%# Eval("CategoryID") %>' Font-Size="Medium"><%# Eval("CategoryName") %></asp:LinkButton>
                        <br />
                        <br />
                    </ItemTemplate>
                </asp:Repeater>
