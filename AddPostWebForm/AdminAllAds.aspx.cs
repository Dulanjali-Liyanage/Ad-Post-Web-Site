...
{
    public partial class AdminAllAds : System.Web.UI.Page
    {
        ...
        protected void DeleteAd(object sender, EventArgs e)
        {
            //get the id of the ad that want to be deleted as a command argument from the delete button in the MyAds.aspx file
        ...
        //AdminAllAds.aspx file sending the postID which needed to be viewed as an command argument
